...
ISEStep( "ngdbuild",
         "-intstyle ise -p xc6slx16csg324-3 -dd _ngo -uc \"kadai3.ucf\" \"kadai3.edf\"" );
ISEStep( "map",
         "-intstyle pa -w \"kadai3.ngd\"" );
ISEStep( "par",
         "-intstyle pa \"kadai3.ncd\" -w \"kadai3_routed.ncd\"" );
ISEStep( "trce",
         "-intstyle ise -o \"kadai3.twr\" -v 30 -l 30 \"kadai3_routed.ncd\" \"kadai3.pcf\"" );
ISEStep( "xdl",
         "-secure -ncd2xdl -nopips \"kadai3_routed.ncd\" \"kadai3_routed.xdl\"" );
