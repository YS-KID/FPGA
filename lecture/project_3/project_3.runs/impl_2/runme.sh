...
EAStep ngdbuild -intstyle ise -p xc6slx16csg324-3 -dd _ngo -uc "kadai3.ucf" "kadai3.edf"
EAStep map -intstyle pa -w "kadai3.ngd"
EAStep par -intstyle pa "kadai3.ncd" -w "kadai3_routed.ncd"
EAStep trce -intstyle ise -o "kadai3.twr" -v 30 -l 30 "kadai3_routed.ncd" "kadai3.pcf"
EAStep xdl -secure -ncd2xdl -nopips "kadai3_routed.ncd" "kadai3_routed.xdl"
